...
export const Calendar: React.FC<IconProps> = (props) => (
  <BaseSVGIcon width="24" height="24" fill={COLOR_BLACK_4} viewBox="0 0 29 29" {...props}>
    ...
    <mask id="mask0_420_2397" maskUnits="userSpaceOnUse" x="3" y="2" width="18" height="20">
