...
export default [{
  ...
  type: 'function', stateMutability: 'nonpayable', outputs: [], name: 'deployERC20BurnablePausableFreezableToken', inputs: [{ type: 'address[2]', name: 'tokenToPayAndOwner', internalType: 'address[2]' }, { type: 'string', name: 'name', internalType: 'string' }, { type: 'string', name: 'symbol', internalType: 'string' }, { type: 'uint8', name: '_decimals', internalType: 'uint8' }, { type: 'address[]', name: 'owner', internalType: 'address[]' }, { type: 'uint256[]', name: 'initSupply', internalType: 'uint256[]' }, { type: 'uint256[]', name: 'timestamp', internalType: 'uint256[]' }],
}, {
  type: 'function', stateMutability: 'nonpayable', outputs: [], name: 'deployERC20PausableFreezableToken', inputs: [{ type: 'address[2]', name: 'tokenToPayAndOwner', internalType: 'address[2]' }, { type: 'string', name: 'name', internalType: 'string' }, { type: 'string', name: 'symbol', internalType: 'string' }, { type: 'uint8', name: '_decimals', internalType: 'uint8' }, { type: 'address[]', name: 'owner', internalType: 'address[]' }, { type: 'uint256[]', name: 'initSupply', internalType: 'uint256[]' }, { type: 'uint256[]', name: 'timestamp', internalType: 'uint256[]' }],
}, {
